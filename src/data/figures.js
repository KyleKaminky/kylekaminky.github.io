/*
   ...
   Entry shape:
     ...
     status  'Live' once ported, 'Video · porting' until then
...
export const FIGS = [
  { id: 'intro', num: '01', title: 'Introduction', domain: 'Overview', status: 'Video \u00b7 porting',
  ...
  { id: 'binary', num: '02', title: 'Binary clock', domain: 'Digital logic', status: 'Video \u00b7 porting',
  ...
  { id: 'monte', num: '03', title: 'Estimating π by Monte Carlo', domain: 'Probability', status: 'Video \u00b7 porting',
  ...
  { id: 'ook', num: '04', title: 'On-off keying', domain: 'Communications', status: 'Video \u00b7 porting',
  ...
  { id: 'generative', num: '05', title: 'Generative art', domain: 'Algorithms', status: 'Video \u00b7 porting',
  ...
  { id: 'birthday', num: '06', title: 'Birthday paradox simulator', domain: 'Probability', status: 'Video \u00b7 porting',
  ...
  { id: 'signal', num: '07', title: 'Signal types', domain: 'Signal processing', status: 'Live',
  ...
  { id: 'counting', num: '08', title: 'Counting', domain: 'Number systems', status: 'Video \u00b7 porting',
  ...
  { id: 'orbits', num: '09', title: 'Satellite orbits', domain: 'Orbital mechanics', status: 'Video \u00b7 porting',
  ...
  { id: 'keypad', num: '10', title: 'Keypad circuit', domain: 'Circuits', status: 'Video \u00b7 porting',
  ...
  { id: 'amfm', num: '11', title: 'AM / FM', domain: 'Communications', status: 'Video \u00b7 porting',
